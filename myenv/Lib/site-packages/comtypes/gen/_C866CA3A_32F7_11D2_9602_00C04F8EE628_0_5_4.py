...
__all__ = [
    'SGPronounciation', 'DISPID_SDKOpenKey', 'DISPID_SGRSTsCount',
    'SAFT22kHz8BitStereo', 'SP_VISEME_21', 'DISPID_SPILanguageId',
    'SAFTCCITT_uLaw_44kHzStereo', 'SpeechFormatType', 'SGSEnabled',
    'DISPID_SPRuleChildren', 'DISPID_SPIEnginePrivateData',
    'SPFM_CREATE', 'DISPID_SRRSpeakAudio', 'DISPID_SVVolume',
    'SSFMCreateForWrite', 'SAFT8kHz16BitStereo',
    'SpeechCategoryRecoProfiles', 'DISPID_SGRsCommit', 'SPSLMA',
    'DISPID_SPEAudioTimeOffset', 'SWPKnownWordPronounceable',
    'SPEI_UNDEFINED', 'SECHighConfidence',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPEI_RESERVED6',
    'SDA_One_Trailing_Space', 'SpeechMicTraining', 'SPAUDIOSTATUS',
    'DISPID_SGRAddResource', 'ISpRecoGrammar2', 'DISPID_SPIGetText',
    'DISPID_SABIBufferSize', 'SPPS_Unknown', 'DISPID_SGRSTNextState',
    'DISPID_SpeechVoiceStatus', 'SPSHORTCUTTYPE', 'SPPHRASEPROPERTY',
    'SREAllEvents', 'DISPID_SVSkip', 'SPSFunction',
    'ISpXMLRecoResult', 'SPFM_CREATE_ALWAYS',
    'SPEI_START_INPUT_STREAM', 'SAFT32kHz8BitMono',
    'DISPID_SpeechPhraseInfo', 'SPDATAKEYLOCATION', 'SRSEDone',
    'DISPID_SRGDictationSetState', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SRCEHypothesis', 'ISpPhraseAlt', 'DISPID_SLWLangId',
    'SPSERIALIZEDRESULT', 'ISpeechGrammarRuleState', 'ISpPhrase',
    'SpeechPropertyAdaptationOn', 'SP_VISEME_12', 'STSF_LocalAppData',
    'SAFTDefault', 'SVP_9', 'SpeechPropertyNormalConfidenceThreshold',
    'SREStreamEnd', 'DISPID_SPRsItem',
    'DISPID_SpeechPhraseReplacements', 'SBOPause',
    'DISPID_SLGenerationId', 'SRADefaultToActive',
    'DISPID_SRCRecognizer', 'DISPIDSPRG', 'DISPID_SAStatus',
    'SPCATEGORYTYPE', 'SVSFPurgeBeforeSpeak', 'SPSTREAMFORMATTYPE',
    'SPAUDIOSTATE', 'SpResourceManager', 'SPSHT_NotOverriden',
    'SP_VISEME_17', 'DISPID_SVSInputWordPosition',
    'ISpeechMMSysAudio', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SVGetProfiles', 'SpeechInterference', 'SDKLCurrentConfig',
    'SpNullPhoneConverter', 'SpeechBookmarkOptions',
    'SAFT48kHz16BitStereo', 'SpeechVoiceEvents', 'SPAR_Unknown',
    'SPEI_MIN_SR', 'SPEI_INTERFERENCE', 'SpeechRuleState',
    'DISPID_SPERequiredConfidence', 'SPAO_NONE',
    'DISPID_SpeechAudioStatus', 'eLEXTYPE_PRIVATE4', 'SPEVENTENUM',
    'Speech_StreamPos_RealTime', 'DISPID_SVIsUISupported', 'ISpAudio',
    'SPSSuppressWord', 'SpeechDisplayAttributes', 'DISPID_SLWType',
    'SPRECORESULTTIMES', 'SWTAdded', 'STSF_CommonAppData',
    'SpeechDataKeyLocation', 'DISPID_SLPsItem',
    'DISPID_SDKGetStringValue', 'STCInprocServer', 'DISPID_SOTCSetId',
    'SPEI_START_SR_STREAM', 'DISPID_SGRSTText', 'SITooSlow',
    'SpeechRegistryLocalMachineRoot', 'SPRECOSTATE',
    'eLEXTYPE_VENDORLEXICON', 'SREInterference',
    'SpTextSelectionInformation', '__MIDL_IWinTypes_0009',
    'DISPID_SRCreateRecoContext', 'SVP_0', 'SVP_16',
    'SPAUDIOBUFFERINFO', 'eLEXTYPE_PRIVATE3',
    'DISPID_SRCRequestedUIType', 'SAFT12kHz8BitMono', 'SVSFParseSapi',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SBSWrite',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SPAs_NewEnum',
    'DISPID_SASNonBlockingIO', 'SPEI_SR_AUDIO_LEVEL', 'SPXRO_SML',
    'SPPHRASEREPLACEMENT', 'DISPID_SRCVoicePurgeEvent',
    'STSF_AppData', 'SPEI_RESERVED3', 'DISPID_SWFEBlockAlign',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SECLowConfidence', 'DISPID_SGRsAdd',
    'DISPID_SPRText', 'SPRULESTATE', 'SITooFast',
    'SpInprocRecognizer', 'SpStreamFormatConverter',
    'SPXMLRESULTOPTIONS', 'SpSharedRecoContext', 'DISPID_SGRClear',
    'SVP_1', 'SVEViseme', 'DISPID_SpeechLexiconPronunciation',
    'SAFTADPCM_11kHzStereo', 'DISPID_SRCEAudioLevel',
    'ISpeechCustomStream', 'Speech_Max_Pron_Length',
    'SECNormalConfidence', 'SVSFIsFilename',
    'SPINTERFERENCE_TOOQUIET', 'SREPrivate', 'SPWF_INPUT',
    'DISPID_SOTCDefault', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SPISaveToMemory', 'DISPID_SABIMinNotification',
    'DISPID_SRCCreateGrammar', '_RemotableHandle',
    'DISPID_SpeechMMSysAudio', 'DISPID_SLPType', 'ISpeechVoice',
    'ISpeechAudioBufferInfo', 'DISPID_SpeechPhraseAlternates',
    'SPEI_FALSE_RECOGNITION', 'eLEXTYPE_PRIVATE8',
    'SPAO_RETAIN_AUDIO', 'DISPID_SRGCmdSetRuleState',
    'tagSPTEXTSELECTIONINFO', 'SRTExtendableParse', 'SRSEIsSpeaking',
    'ISpeechGrammarRules', 'DISPID_SWFEBitsPerSample',
    'SAFT48kHz8BitMono', 'SVP_4', 'eLEXTYPE_PRIVATE16',
    'ISpeechPhraseReplacement', 'DISPID_SDKSetBinaryValue',
    'SAFTADPCM_8kHzStereo', 'SpeechPropertyResourceUsage',
    'SAFT22kHz8BitMono', 'SpeechCategoryAppLexicons',
    'DISPID_SGRName', 'DISPID_SOTMatchesAttributes',
    'DISPID_SVEViseme', 'SP_VISEME_14', 'SpeechAudioFormatGUIDText',
    'SPRST_INACTIVE_WITH_PURGE', 'SPGS_EXCLUSIVE',
    'SECFEmulateResult', 'eLEXTYPE_PRIVATE11',
    'SpeechRegistryUserRoot', 'SPAR_Medium', 'SAFTGSM610_11kHzMono',
    'SpeechWordPronounceable', 'SPBO_NONE',
    'DISPID_SPIRetainedSizeBytes', 'eLEXTYPE_PRIVATE14',
    'DISPID_SLRemovePronunciation', 'ISpRecoGrammar', 'SPEI_MAX_TTS',
    'DISPID_SRRRecoContext', 'SPVPRIORITY', 'SPSNotOverriden',
    'DISPID_SGRSTWeight', 'DISPID_SpeechPhraseProperty',
    'DISPID_SASCurrentSeekPosition', 'SPAS_STOP',
    'DISPID_SOTGetDescription', 'SPSHORTCUTPAIR', 'SpeechAudioState',
    'SVEPrivate', 'SAFT8kHz16BitMono', 'SVP_15', 'SVP_19',
    'DISPID_SpeechMemoryStream', 'DISPID_SPRuleNumberOfElements',
    'SVF_Emphasis', 'DISPID_SRCERequestUI', 'DISPID_SVEPhoneme',
    'DISPID_SGRs_NewEnum', 'SP_VISEME_9', 'SWTDeleted',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SPRulesCount', 'SREBookmark',
    'DISPID_SRGIsPronounceable', 'DISPID_SpeechLexiconProns',
    'SpeechAudioFormatType', 'SPDKL_CurrentUser', 'SPWORDTYPE',
    'DISPID_SRGCmdLoadFromFile', 'SSFMCreate',
    'SpeechEngineConfidence', 'eLEXTYPE_PRIVATE18',
    'DISPID_SVSyncronousSpeakTimeout', 'ISpeechDataKey',
    'DISPID_SGRSTType', 'SSSPTRelativeToCurrentPosition',
    'SpeechLoadOption', 'SP_VISEME_10', 'SPPS_NotOverriden',
    'DISPID_SGRSTPropertyName', 'ISpeechWaveFormatEx',
    'SPSEMANTICFORMAT', 'ISpNotifySource', 'DISPID_SPRuleConfidence',
    'DISPID_SPIAudioStreamPosition', '_ISpeechRecoContextEvents',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SWFEChannels', 'ISpMMSysAudio',
    'SSSPTRelativeToEnd', '_ISpeechVoiceEvents',
    'SPXRO_Alternates_SML', 'SECFIgnoreKanaType',
    'eLEXTYPE_RESERVED9', 'SREAudioLevel', 'SVSFUnusedFlags',
    'SpNotifyTranslator', 'DISPID_SLPSymbolic', 'DISPID_SRGId',
    'SPEI_MIN_TTS', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SpeechLexiconWords', 'DISPID_SPRules_NewEnum',
    'SREHypothesis', 'SAFT11kHz16BitMono', 'DISPID_SPCPhoneToId',
    'SRTSMLTimeout', 'SRSActiveAlways', 'SP_VISEME_19', 'SPSModifier',
    'SPBO_AHEAD', 'SpeechRecoContextState', 'SPDKL_DefaultLocation',
    'ISpeechPhraseRules', 'SDKLDefaultLocation', 'DISPIDSPTSI',
    'DISPID_SGRSTs_NewEnum', 'ISpeechPhraseElements',
    'DISPID_SPRsCount', 'SPVISEMES', 'DISPID_SGRsDynamic',
    'SPEI_PHONEME', 'SPSUnknown',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SVResume',
    'SPAS_PAUSE', 'ISpeechRecoResult',
    'DISPID_SRSCurrentStreamPosition', 'SpLexicon', 'SITooQuiet',
    'SPPROPERTYINFO', 'IStream', 'SVEAudioLevel',
    'DISPIDSPTSI_SelectionLength', 'SP_VISEME_5',
    'DISPID_SGRsCommitAndSave', 'SAFTText', 'SPEI_REQUEST_UI',
    'SPAS_CLOSED', 'eLEXTYPE_PRIVATE1',
    'DISPID_SRSSupportedLanguages', 'DISPID_SAFType',
    'DISPID_SRCCmdMaxAlternates', 'SFTInput', 'SECFNoSpecialChars',
    'ISpeechPhraseReplacements', 'DISPID_SRRAudio',
    'SDA_Consume_Leading_Spaces', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SRProfile', 'DISPID_SRCERecognition',
    'ISpeechObjectTokens', 'ISpGrammarBuilder',
    'IInternetSecurityManager', 'SpeechTokenKeyUI', 'ISpProperties',
    'DISPID_SRCPause', 'DISPID_SPEDisplayAttributes',
    'SPCT_SUB_DICTATION', 'DISPID_SGRsFindRule', 'ISpRecognizer3',
    'ISpeechPhraseProperties', 'SPWT_DISPLAY', 'DISPID_SWFEFormatTag',
    'SpeechCategoryPhoneConverters', 'DISPID_SRCEventInterests',
    'DISPID_SLAddPronunciation', 'SAFT48kHz16BitMono', 'SASClosed',
    'DISPID_SPEEngineConfidence', 'DISPID_SPIElements',
    'eLEXTYPE_PRIVATE13', 'SPRECOCONTEXTSTATUS', 'DISPID_SRCBookmark',
    'SpSharedRecognizer', 'SASPause', 'DISPID_SpeechGrammarRuleState',
    'IEnumString', 'SpFileStream', 'DISPID_SpeechRecognizer',
    'SPEI_TTS_PRIVATE', 'DISPID_SRIsShared', 'DISPID_SDKEnumValues',
    'STCInprocHandler', 'DISPID_SRAudioInput', 'SDKLLocalMachine',
    'SPEI_END_SR_STREAM', 'SPDKL_LocalMachine',
    'DISPID_SVEAudioLevel', 'ISpRecoContext', 'SPBOOKMARKOPTIONS',
    'SGSExclusive', 'DISPID_SRGetRecognizers', 'DISPID_SGRSTsItem',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SVESentenceBoundary',
    'SINone', 'DISPID_SpeechObjectTokens', 'SRERecoOtherContext',
    'DISPID_SREmulateRecognition', 'DISPID_SAEventHandle',
    'DISPID_SVStatus', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SGLexical', 'DISPID_SpeechRecoResult2', 'DISPID_SVAlertBoundary',
    'SPINTERFERENCE_TOOFAST', 'SPRST_ACTIVE',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpObjectWithToken', 'DISPID_SLWWord', 'DISPID_SLWsItem',
    'SpMMAudioOut', 'SpeechTokenKeyFiles', 'SVPOver', 'SpObjectToken',
    'DISPID_SRStatus', 'DISPID_SpeechDataKey', 'DISPID_SRGCommit',
    'SREStreamStart', 'DISPID_SGRAddState', 'DISPID_SVSpeakStream',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SpeechPhraseElement',
    'DISPID_SPAStartElementInResult', 'DISPID_SRRTTickCount',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SpeechGrammarRules',
    'SPEI_RESERVED2', 'SASRun', 'DISPID_SWFEExtraData',
    'DISPID_SDKSetStringValue', 'SVEPhoneme', 'ISpeechLexicon',
    'SPPS_RESERVED4', 'SVP_3', 'SRESoundStart',
    ...
    'DISPID_SPAPhraseInfo', 'ISpeechAudioFormat', 'SPRULE',
    'DISPID_SOTCreateInstance', 'SPWT_PRONUNCIATION', 'SSTTDictation',
    'SPLO_STATIC', 'SPVPRI_OVER', 'SVF_None', 'DISPID_SPEDisplayText',
    'SPPS_RESERVED2', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SMSADeviceId',
    'SpeechTokenIdUserLexicon', 'DISPID_SpeechLexiconWord',
    'SSTTTextBuffer', 'DISPID_SDKEnumKeys', 'SpeechWordType',
    'DISPID_SRGetPropertyNumber', 'SpeechCategoryRecognizers',
    'DISPID_SPARecoResult', 'ISpeechTextSelectionInformation',
    'SRATopLevel', 'SpeechGrammarTagDictation', 'SAFTADPCM_22kHzMono',
    'IEnumSpObjectTokens', 'DISPID_SPIReplacements', 'eLEXTYPE_APP',
    'SGRSTTEpsilon', 'SpeechAudioVolume', 'DISPID_SRGRecoContext',
    'DISPID_SOTGetStorageFileName', 'SPSHT_Unknown',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SPRuleName', 'SVPAlert',
    'SPLOADOPTIONS', 'SGRSTTDictation', 'SAFTCCITT_ALaw_22kHzMono',
    'SRTAutopause', 'SPEI_WORD_BOUNDARY',
    'SPEI_PROPERTY_STRING_CHANGE', 'SpeechRecognizerState',
    'SpeechPropertyResponseSpeed', 'ISpStreamFormat', 'SVSFParseSsml',
    'DISPID_SPRNumberOfElements', 'SPBO_TIME_UNITS',
    'SPEI_SOUND_START', 'SpeechTokenValueCLSID', 'ISpRecoContext2',
    'SPBINARYGRAMMAR', 'SPINTERFERENCE_NOSIGNAL',
    'SpInProcRecoContext', 'SPSHT_EMAIL',
    'DISPID_SRCSetAdaptationData', 'SpeechStreamSeekPositionType',
    'SpeechVoiceCategoryTTSRate', 'SpeechRecoProfileProperties',
    'DISPID_SRCRetainedAudio', 'SDTAudio', 'SPEI_VISEME',
    'SPEI_ADAPTATION', 'SAFTNonStandardFormat', 'SECFDefault',
    'SGRSTTRule', 'SVSFNLPMask', 'SAFT12kHz16BitMono',
    'DISPID_SRGRules', 'SPEI_RESERVED5', 'SAFT12kHz16BitStereo',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SOTCategory',
    'DISPID_SpeechRecoResult', 'ISpeechPhraseElement',
    'DISPID_SVSRunningState', 'DISPID_SPIEngineId',
    'DISPID_SVPriority', 'STCAll', 'SPEVENTSOURCEINFO',
    'STCRemoteServer', 'DISPID_SLGetWords', 'SPSHT_OTHER',
    'DISPID_SGRSTPropertyValue', 'ISpLexicon', 'STCLocalServer',
    'SVSFIsXML', 'SAFTGSM610_22kHzMono', 'SPPS_LMA',
    ...
    'DISPID_SVSVisemeId', 'SPRS_ACTIVE_USER_DELIMITED',
    'SVSFlagsAsync', 'SPEI_TTS_AUDIO_LEVEL', 'SREAdaptation',
    'SPRS_INACTIVE', 'SDTPronunciation', 'SLTApp', '_SPAUDIOSTATE',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SpeechPhraseReplacement',
    'eLEXTYPE_USER', 'DISPID_SBSFormat', 'SAFTCCITT_ALaw_44kHzStereo',
    'WAVEFORMATEX', 'SPINTERFERENCE', 'SpAudioFormat',
    'SPCT_DICTATION', 'SVEAllEvents', 'SASStop',
    ...
    'SPWAVEFORMATTYPE', 'DISPID_SLWPronunciations', 'SP_VISEME_6',
    'SDTReplacement', 'SPPHRASE', 'SPCT_SUB_COMMAND',
    'DISPID_SGRsItem', 'SPSVerb', 'DISPID_SPIAudioSizeBytes',
    'SPPS_Noncontent', 'DISPID_SVVoice', 'DISPID_SPRs_NewEnum',
    'ISpeechRecoGrammar', 'DISPID_SRSAudioStatus', 'SP_VISEME_1',
    'SP_VISEME_8', 'DISPID_SRCEFalseRecognition', 'ISpObjectToken',
    'SP_VISEME_3', 'SITooLoud', 'SINoSignal', 'SPAS_RUN',
    'SRAInterpreter', 'DISPID_SRGDictationUnload', 'SRCS_Enabled',
    'ISpVoice', 'SAFTGSM610_8kHzMono', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SRSetPropertyString', 'DISPID_SVAudioOutput',
    'DISPID_SPIProperties', 'SRAExport', 'ISpRecoResult',
    'DISPID_SCSBaseStream', 'SPSEMANTICERRORINFO',
    'SAFT8kHz8BitStereo', 'DISPID_SGRSAddRuleTransition',
    'SpeechTokenShellFolder', 'SVSFNLPSpeakPunc', 'SPWT_LEXICAL',
    'SDTLexicalForm', 'SPFM_NUM_MODES', 'SPEI_SR_RETAINEDAUDIO',
    'ISpEventSink', 'SpWaveFormatEx', 'SAFT11kHz8BitMono',
    'SAFT32kHz8BitStereo', 'SVEWordBoundary', 'eLEXTYPE_PRIVATE17',
    'DISPID_SGRSRule', 'SPFM_OPEN_READWRITE',
    'ISpeechPhraseAlternates', 'SAFT22kHz16BitStereo', 'SpStream',
    'ISpPhoneConverter', 'DISPID_SRRDiscardResultInfo',
    'ISpSerializeState', 'SVPNormal', 'ISpEventSource',
    'eLEXTYPE_RESERVED8', 'DISPID_SPIAudioSizeTime', 'ISpRecognizer2',
    'DISPID_SOTIsUISupported', 'ISpStream', 'DISPID_SpeechBaseStream',
    'SPRECOGNIZERSTATUS', 'DISPID_SpeechXMLRecoResult', 'SPFILEMODE',
    'DISPID_SMSAMMHandle', 'UINT_PTR', 'ISpNotifySink',
    'DISPID_SGRInitialState', 'DISPID_SRCERecognitionForOtherContext',
    'SREPhraseStart', 'DISPID_SpeechPhraseBuilder',
    'SPEI_RECO_STATE_CHANGE', 'SVP_2',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPRulesItem', 'LONG_PTR', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SOTDataKey',
    'DISPID_SPPsCount', 'SAFTADPCM_22kHzStereo',
    'SpeechRuleAttributes', 'SPINTERFERENCE_NOISE', 'DISPID_SFSClose',
    'ISpeechObjectToken', 'SPGRAMMARSTATE', 'SpeechUserTraining',
    'SVP_5', 'SPPS_Modifier', 'SP_VISEME_20',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPEsItem', 'SDTRule',
    'SPINTERFERENCE_TOOSLOW', 'SVSFParseAutodetect',
    'DISPID_SRRSetTextFeedback', 'DISPID_SPRuleId',
    'DISPID_SOTRemove', 'eLEXTYPE_PRIVATE9', 'DISPID_SPRFirstElement',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPEI_RECOGNITION',
    'DISPID_SLPPartOfSpeech', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SVGetVoices', 'DISPID_SDKDeleteValue', 'SPWORDLIST',
    'SREFalseRecognition', 'SP_VISEME_11', 'SpUnCompressedLexicon',
    'SpeechTokenKeyAttributes', 'SAFT44kHz8BitMono', 'SPPS_RESERVED1',
    'SPCS_ENABLED', 'eLEXTYPE_LETTERTOSOUND', 'ISpeechRecoContext',
    'ISpeechLexiconPronunciations', 'eLEXTYPE_RESERVED7',
    'DISPID_SLWsCount', 'SDTProperty', 'SGDisplay',
    'SpeechAudioProperties', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SLPPhoneIds', 'SAFT11kHz8BitStereo',
    'DISPID_SVAudioOutputStream', 'SPEI_PHRASE_START', 'SVF_Stressed',
    'eLEXTYPE_PRIVATE12', 'DISPID_SPAsCount', 'ISpeechXMLRecoResult',
    'SPCT_SLEEP', 'DISPID_SRGetPropertyString', 'SDTDisplayText',
    'SPWF_SRENGINE', 'SAFTCCITT_uLaw_22kHzStereo',
    'SpeechCategoryAudioIn', 'SAFTCCITT_uLaw_44kHzMono',
    'ISpPhoneticAlphabetSelection', 'SPPHRASEELEMENT',
    'SRCS_Disabled', 'SPCONTEXTSTATE', 'SP_VISEME_18',
    'eLEXTYPE_PRIVATE6', 'DISPID_SOTGetAttribute',
    'DISPID_SpeechObjectToken', 'SVEStartInputStream',
    'DISPID_SVEWord', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SOTCGetDataKey', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SPPEngineConfidence', 'SPEI_SENTENCE_BOUNDARY',
    'SPRS_ACTIVE', 'SAFTExtendedAudioFormat', 'SPAUDIOOPTIONS',
    'DISPID_SpeechVoiceEvent', 'SAFTCCITT_uLaw_8kHzMono',
    'SPPS_Function', 'Speech_Max_Word_Length', 'DISPID_SRGState',
    'SpeechGrammarTagUnlimitedDictation', 'ISpObjectTokenCategory',
    'DISPID_SpeechPhraseRule', 'ISpRecoCategory',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SOTsCount',
    'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SLAddPronunciationByPhoneIds', 'SVP_6',
    'DISPID_SGRSAddWordTransition', 'SPBO_PAUSE',
    'DISPID_SPPFirstElement', 'SVP_13', 'SPSERIALIZEDPHRASE',
    'SAFTADPCM_44kHzStereo', 'SVP_21', 'DISPID_SRGReset',
    'DISPID_SVSPhonemeId', 'ISpStreamFormatConverter',
    'DISPID_SRCCreateResultFromMemory', 'SAFT32kHz16BitStereo',
    'SpeechRecoEvents', 'SpeechVoicePriority', 'SVP_17',
    'DISPID_SRCERecognizerStateChange',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SVP_7', 'SPPARTOFSPEECH',
    'SAFT48kHz8BitStereo', 'SVP_20', 'SPWORDPRONUNCIATION',
    'SpeechAudioFormatGUIDWave', 'ISpeechRecoResultDispatch',
    'DISPID_SRCVoice', 'SRSActive', 'SAFTCCITT_ALaw_44kHzMono',
    'SRSInactive', 'SRERequestUI', 'DISPID_SABIEventBias',
    'DISPID_SRRTimes', 'SPEI_SR_BOOKMARK', 'eLEXTYPE_PRIVATE15',
    'SpObjectTokenCategory', 'DISPID_SpeechRecoContext',
    'SPEI_SR_PRIVATE', 'DISPID_SRCState',
    ...
    'DISPID_SPEPronunciation', 'SpPhraseInfoBuilder',
    'eWORDTYPE_ADDED', 'DISPID_SRRGetXMLResult',
    'DISPID_SWFESamplesPerSec', 'SP_VISEME_2', 'SDKLCurrentUser',
    'DISPID_SVDisplayUI', 'SAFT12kHz8BitStereo',
    'DISPID_SRCEEnginePrivate', 'SECFIgnoreWidth',
    'ISpResourceManager', 'DISPID_SpeechGrammarRule',
    'SAFTNoAssignedFormat', 'DISPID_SLPs_NewEnum',
    'Speech_StreamPos_Asap', 'SPFM_OPEN_READONLY', 'SVSFParseMask',
    'SVEVoiceChange', 'DISPID_SRRTStreamTime', 'ISpeechBaseStream',
    'SVSFVoiceMask', 'SpeechCategoryVoices',
    'DISPID_SLGetGenerationChange', 'SPEI_VOICE_CHANGE',
    'DISPID_SRGDictationLoad', 'DISPID_SRGSetTextSelection',
    'SDA_No_Trailing_Space', 'SPGS_ENABLED',
    'SpPhoneticAlphabetConverter', 'DISPID_SOTs_NewEnum',
    'SpeechGrammarState', 'SVSFPersistXML', 'DISPID_SRSClsidEngine',
    'eLEXTYPE_PRIVATE7', 'DISPID_SpeechPhraseElements',
    'SSSPTRelativeToStart', 'ISpeechLexiconWords',
    'SSFMOpenReadWrite', 'eLEXTYPE_PRIVATE20', 'DISPID_SBSRead',
    'ISequentialStream', 'DISPID_SGRSTPropertyId',
    'DISPID_SGRAttributes', 'ISpeechRecoResultTimes',
    'DISPID_SOTRemoveStorageFileName',
    'DISPID_SASCurrentDevicePosition', 'SPADAPTATIONRELEVANCE',
    'SAFT24kHz16BitMono', 'DISPID_SLPsCount',
    'DISPID_SVSInputSentencePosition', 'SPEI_END_INPUT_STREAM',
    'SpeechVoiceSpeakFlags', 'DISPID_SOTCId', 'SINoise',
    'ISpeechRecoResult2', 'DISPID_SPRuleEngineConfidence',
    'SpeechTokenContext', 'SPRST_INACTIVE', 'SPEI_HYPOTHESIS',
    'DISPID_SPEAudioStreamOffset', 'SGRSTTTextBuffer',
    'DISPID_SRRTLength', 'DISPID_SRCEInterference',
    'SWPUnknownWordPronounceable', 'SPTEXTSELECTIONINFO',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SPPs_NewEnum',
    'ISpeechAudioStatus', 'eLEXTYPE_PRIVATE19',
    'ISpPhoneticAlphabetConverter', 'SPAR_Low',
    'SpeechStreamFileMode', 'DISPID_SVRate', 'DISPID_SPELexicalForm',
    'DISPID_SVEBookmark', 'SpCompressedLexicon', 'SRERecognition',
    'ISpeechPhraseInfo', 'SRAORetainAudio',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPSHORTCUTPAIRLIST',
    'SpeechDiscardType', 'DISPID_SBSSeek',
    'DISPID_SpeechAudioBufferInfo', 'SpeechCategoryAudioOut',
    'DISPID_SDKSetLongValue', 'DISPID_SRAudioInputStream',
    'SAFT16kHz8BitStereo', 'DISPID_SMSALineId', 'SAFT16kHz8BitMono',
    'ISpeechRecognizerStatus', 'DISPID_SPIGrammarId',
    'DISPID_SPEs_NewEnum', 'SVP_8', 'SGDSActiveWithAutoPause',
    'DISPID_SVSLastResult', 'SpPhoneConverter', 'SPEI_SOUND_END',
    'SPPS_Noun', 'SVSFDefault', 'ISpeechLexiconPronunciation',
    'SECFIgnoreCase', 'eWORDTYPE_DELETED',
    'DISPID_SPANumberOfElementsInResult', 'SAFT16kHz16BitStereo',
    'tagSPPROPERTYINFO', 'DISPID_SVSpeakCompleteEvent',
    'SVESentenceBoundary', 'SpCustomStream', 'Speech_Default_Weight',
    'SPWORDPRONOUNCEABLE', 'SPVPRI_ALERT', 'SFTSREngine',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SpeechPropertyHighConfidenceThreshold', 'SRESoundEnd',
    'SP_VISEME_16', 'SDTAlternates', 'SAFT44kHz16BitMono',
    'ISpeechMemoryStream', 'DISPID_SABufferNotifySize',
    'SSTTWildcard', 'SpeechEmulationCompareFlags', 'SPSMF_UPS',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SpeechAudioFormat',
    'SGRSTTWildcard', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SpeechPhraseProperties', 'DISPID_SRSetPropertyNumber',
    'SPEI_MAX_SR', 'SGSDisabled', 'SPGRAMMARWORDTYPE',
    'DISPID_SPEActualConfidence', 'SPSInterjection', 'SPCS_DISABLED',
    'SPEI_TTS_BOOKMARK', 'DISPID_SPPId', 'SPPS_SuppressWord',
    ...
    'ISpeechFileStream', 'DISPID_SPPParent', 'SRAImport',
    'ISpNotifyTranslator', 'DISPID_SMSGetData',
    'DISPID_SPEAudioSizeBytes', 'SPPS_Interjection', 'SVSFIsNotXML',
    'SREPropertyNumChange', 'DISPID_SPRDisplayAttributes',
    'SAFTGSM610_44kHzMono', 'ISpeechPhraseAlternate',
    'DISPID_SLPLangId', 'ISpRecognizer', 'SAFTADPCM_8kHzMono',
    'DISPID_SPPsItem', 'SPGS_DISABLED', 'SAFT24kHz8BitStereo',
    'SpVoice', 'SPEVENT', 'SRSInactiveWithPurge',
    'SREPropertyStringChange', 'DISPID_SPRuleFirstElement',
    'SpMMAudioEnum', 'DISPID_SFSOpen', 'SP_VISEME_0',
    'SAFT24kHz8BitMono', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SRCResume', 'DISPID_SPCIdToPhone',
    'DISPID_SpeechFileStream', 'SP_VISEME_13',
    'ISpeechObjectTokenCategory', 'SP_VISEME_7',
    'SAFTADPCM_44kHzMono', 'SPLO_DYNAMIC', 'SPINTERFERENCE_NONE',
    'SAFTADPCM_11kHzMono', 'SVP_12', 'SVP_18',
    'DISPID_SVEventInterests', 'DISPID_SpeechVoice',
    'eLEXTYPE_RESERVED6', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SPPValue', 'DISPID_SOTDisplayUI',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SpeechAddRemoveWord',
    'DISPID_SRCEAdaptation', 'SpMMAudioIn', 'SAFT32kHz16BitMono',
    'SRTReSent', 'SAFTCCITT_ALaw_22kHzStereo', 'SGDSInactive',
    'DISPID_SDKCreateKey', 'ISpDataKey', 'SPRST_NUM_STATES',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SPPConfidence',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SLODynamic',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SRGSetWordSequenceData',
    'SGLexicalNoSpecialChars', 'SpShortcut', 'SRTStandard',
    'SAFT8kHz8BitMono', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SPCT_COMMAND', 'DISPID_SPACommit', 'DISPID_SpeechCustomStream',
    'SpeechRetainedAudioOptions', 'SpMemoryStream',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRCESoundEnd', 'DISPID_SRCEBookmark', 'SPPS_Verb',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SPPChildren',
    'SpeechLexiconType', 'SVEEndInputStream', 'ISpeechResourceLoader',
    'SAFT22kHz16BitMono', 'ISpeechLexiconWord', 'DISPID_SPAsItem',
    'DISPID_SpeechLexicon', 'SBONone', 'SPVPRI_NORMAL',
    'DISPID_SVSLastBookmark', 'SP_VISEME_4',
    'DISPID_SVSCurrentStreamNumber', 'SpeechRunState', 'tagSTATSTG',
    'DISPID_SRState', 'DISPID_SRGetFormat',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SGRId',
    'SDA_Two_Trailing_Spaces', 'SPPHRASERULE', 'eLEXTYPE_PRIVATE2',
    'DISPID_SRCEPropertyStringChange', 'eLEXTYPE_RESERVED4',
    'SPEI_RESERVED1', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SADefaultFormat', 'DISPID_SVEVoiceChange',
    'DISPID_SOTsItem', 'DISPID_SAVolume', 'DISPID_SDKDeleteKey',
    'DISPID_SAFGuid', 'DISPID_SASetState', 'DISPID_SRDisplayUI',
    'SPDKL_CurrentConfig', 'ISpShortcut', 'SPAR_High', 'SGRSTTWord',
    'DISPID_SRCEPropertyNumberChange', 'SVP_10', 'DISPID_SPIRule',
    'DISPID_SpeechAudio', 'DISPID_SPEsCount',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SRIsUISupported',
    'DISPID_SpeechPhraseRules', 'SpeechSpecialTransitionType',
    'DISPID_SDKGetlongValue', 'SpeechGrammarRuleStateTransitionType',
    ...
    'DISPID_SPERetainedStreamOffset', 'DISPID_SPERetainedSizeBytes',
    'ISpeechPhraseRule', 'DISPID_SPPName', 'SAFT16kHz16BitMono',
    'SREStateChange', 'DISPID_SVWaitUntilDone', 'DISPID_SOTId',
    'SVP_11', 'DISPID_SPCLangId', 'SPVOICESTATUS',
    'IInternetSecurityMgrSite', 'SpeechVisemeFeature', 'SVEBookmark',
    'SPPS_RESERVED3', 'SPSMF_SAPI_PROPERTIES', 'SPWORD',
    'DISPID_SVEStreamStart', 'SRAONone', 'SpeechEngineProperties',
    'ISpeechVoiceStatus', 'SpeechAllElements',
    'DISPID_SRCEPhraseStart', 'DISPID_SPEAudioSizeTime',
    'DISPID_SMSSetData', 'SGDSActive', 'SVP_14',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SPRuleParent',
    'STSF_FlagCreate', 'SAFTTrueSpeech_8kHz1BitMono',
    'SpeechDictationTopicSpelling', 'ISpeechPhoneConverter',
    'SRADynamic', 'SAFT44kHz8BitStereo', 'SLOStatic',
    'DISPID_SRCESoundStart', 'SPSNoun', 'DISPID_SVSInputWordLength',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SRRecognizer', 'ISpeechAudio',
    'SDTAll', 'DISPID_SRCEEndStream', 'SAFT24kHz16BitStereo',
    'DISPID_SRCRetainedAudioFormat', 'SpeechRecognitionType',
    'DISPID_SABufferInfo', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SPLEXICONTYPE', 'DISPID_SRCEStartStream', 'DISPID_SGRSTRule',
    'eLEXTYPE_PRIVATE10', 'ISpeechRecognizer',
    'DISPID_SVGetAudioOutputs', 'DISPID_SGRsCount', 'SSFMOpenForRead',
    'DISPID_SASState', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SVSpeak', 'SRARoot', 'SLTUser', 'DISPID_SVEStreamEnd',
    'ISpeechPhraseProperty'
]

_check_version('1.2.0', 1700132837.615823)
